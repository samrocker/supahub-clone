          ...
          <div className="flex-center flex-col gap-5">
            ...
            <div className="flex-between flex-row gap-5">
              <Button className="text-white text-xs md:text-sm lg:text-lg flex-between gap-1 md:gap-2 font-semibold px-3 md:px-5 py-6 lg:py-7 bg-primary rounded-sm">
                <Image src='/icons/button-star.png' alt="" width={23} height={23} className="hidden lg:block" />
                <Image src='/icons/button-star.png' alt="" width={15} height={15} className="block lg:hidden" />
                Sign up for free
                </Button>
            ...
            <div className="flex-center gap-3">
              <div className="flex-between gap-2">
                <Image src='/icons/credit-card-icon.png' alt='' height={20} width={20} />
                <h1 className="text-xs md:text-sm font-semibold text-[#495060]">No credit card required</h1>
              </div>
              <div className="flex-center relative">
              <Image src='/icons/dot-icon.png' alt='' height={5} width={5} objectFit="absolute top-50 left-50 cover" />
              </div>
              <div className="flex-between gap-2">
                <Image src='/icons/timer-icon.png' alt='' height={20} width={20} />
                <h1 className="text-xs md:text-sm font-semibold text-[#495060]">14-day free trial</h1>
              </div>
            </div>
          </div>
