...
const RoadmapCard = ({ title, description, imageUrl }: RoadmapCardProps) => {
  return (
    <div className="w-full max-w-[358px] h-screen max-h-[414px] flex-between flex-col gap-5 bg-[#F5F6FA] rounded-3xl">
      <div className="flex-[1] w-full flex flex-col gap-5 items-start justify-center px-10">
